...
public class ShowItems extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel5.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 30, 100, 40));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try {
            ...
            Logger.getLogger(clinet.ShowItems.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        // TODO add your handling code here:
       this.dispose();
       ArrayList<core.Shipping> sL = new ArrayList<>();
        new Shipping(sL, Session, connection).setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        new AddItem(connection).setVisible(true);
