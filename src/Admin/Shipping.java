...
public class Shipping extends javax.swing.JFrame {
    ...
    public Shipping(ArrayList<core.Shipping> L,ArrayList<User> Session,ConnectDB con) {
        initComponents();
        connection=con;
         this.Session = Session;
        sL=L;
        core.Shipping s = new core.Shipping();
        sL=s.SelectAllShippingMetod(con);
         DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
      

        for (int i = 0; i < sL.size(); i++) {
            Vector<Object> data = new Vector<Object>();
            data.add(sL.get(i).Type);
            data.add(sL.get(i).Duration);
            data.add(sL.get(i).CostOfShippingMethod);
...
this.dispose();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        new AddShipping(connection).setVisible(true);
